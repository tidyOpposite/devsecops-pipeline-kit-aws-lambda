...
COMPLETION_OPTIONS = {
    ...
    "preset": ["--help", "--generate"],
    "dashboard": ["--help", "--watch", "--interval", "--mode"],
    "config": ["--help", "--format"],
    "config show": ["--help", "--format"],
    "config new": ["--help", "--preset", "--force", "--generate"],
    "config validate": ["--help", "--strict", "--format"],
    "config diff": ["--help", "--preset", "--exit-code"],
    "config reset": ["--help", "--preset", "--generate"],
    "config set": ["--help", "--generate"],
    "config create": ["--help", "--preset", "--force", "--generate"],
